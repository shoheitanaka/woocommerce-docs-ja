...
WordPressインストールの[プロジェクト構造](/docs/getting-started/project-structure)と独自のニーズに基づいて、`wp-content`ディレクトリのさまざまな部分をバージョン管理し、デプロイすることができます。一般的なアプローチには次のようなものがあります：
