...
新しい SlotFill コンポーネントを追加したい場合は、[Checkout - Slot Fill document](https://github.com/woocommerce/woocommerce/blob/trunk/plugins/woocommerce/client/blocks/packages/checkout/slot/README.md)をチェックしてください。スロットとフィルについての詳細は、[スロットとフィルのドキュメント](/docs/block-development/reference/slot-fills/)をご覧ください。
...
-   `collapsible`：`Boolean|undefined` 配送パッケージパネルが折りたたみ可能かどうか、これはCheckout では false、Cart では未定義です。
